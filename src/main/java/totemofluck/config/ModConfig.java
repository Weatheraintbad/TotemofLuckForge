...
public class ModConfig {
    public static final List<MobEffect> BUFF_POOL = List.of(
            MobEffects.MOVEMENT_SPEED, MobEffects.DIG_SPEED, MobEffects.DAMAGE_BOOST,
            MobEffects.JUMP, MobEffects.REGENERATION,
            MobEffects.FIRE_RESISTANCE, MobEffects.WATER_BREATHING,
            MobEffects.NIGHT_VISION, MobEffects.LUCK
    );
     ...
     * 获取有效的复活效果列表
     */
    public static List<MobEffect> getResurrectionEffects() {
        return List.copyOf(new java.util.ArrayList<>());
    }
